            ...
            <TabsContent value="delete" className="space-y-4 mt-4">
              <div className="rounded-md border bg-muted/40 p-3 text-xs text-muted-foreground space-y-1">
                <p className="font-medium text-foreground text-sm">
                  Как работать с вредной привычкой
                </p>
                <p>
                  Если триггер внутренний (эмоции, желания), то лучше использовать замену.
                  </p>
                  <p>
                  Если триггер внешний (предмет), то поможет сделать триггер незаметным или трудным для выполнения.
                </p>
              </div>
              <form
                onSubmit={handleSubmit(onSubmit)}
