...
const steps: OnboardingStep[] = [
  {
    ...
    description: "Сейччас расскажем, как тут всё работвет",
    icon: <Sparkles className="h-6 w-6" />,
  },
  {
    title: "Триггер → Действие → Награда",
    description: "Каждая привычка состоит из триггера (ситуация), действия (что вы делаете) и награды (как вы себя чувствуете).",
    icon: <Target className="h-6 w-6" />,
  },
  {
    title: "Нейропластичность",
    description: "Факторы как упражнения, сон и питание ускоряют формирование привычек за счёт создания нейронных связей в мозге.",
